use sql_assignment;
create table countries(id integer,name varchar(255),population bigint,capital varchar(255));
select * from countries;
# DATA INSERTION
insert into countries values(1,"china",1382,"Beijing"),          
(2,"India",1326,"Delhi"),
...
insert into countries values(11,"Japan",126,"Tokyo");
insert into countries values(12,"Philippiness",102,"Manila");

set sql_safe_updates = 0;
# Change Delhi to NewDelhi
update countries set capital = "New Delhi" where id=2;   
# Rename Table countries to big countries
Alter table countries rename to big_countries;          

select * from big_countries;

# CREATING TABLE AND RELATIONSHIP BETWEEN TABLES
create table Suppliers(supplier_id int primary key auto_increment,    
supplier_name varchar(255) NOT NULL,
location varchar(255) NOT NULL);

Alter table Suppliers modify column supplier_name  varchar(255) NOT NULL;
...
# CREATING TABLE AND RELATIONSHIP BETWEEN TABLES
create table Stock(id integer primary key auto_increment,           
balance_stock varchar(255),
product_id INTEGER,
...
Alter table Stock modify balance_stock integer;
DESC Stock;

# Data insertion
insert into Suppliers values(1,"flipcart","India"),(2,"Amazon","Ireland");  
   
select * from Suppliers;

# Data insertion
insert into Product values(1,"Tommytippee","Bottle",1),(2,"Luvlap","Bottle",2);  
select * from Product;
# Data insertion
insert into Stock values(1,15,1),(2,20,2);                                     

select * from Stock;

Alter table Suppliers modify supplier_name varchar(255)  NOT NULL unique;       
...
alter table emp add column depno integer;          

select * from emp;

alter table emp rename column emp_id to emp_no;

# switch case with update
update emp set depno =                            
case
...
(10091,'1955-10-04','fe esmabile','Gomatam','M','1992-11-18',7850.00),
...
# creation of index
create unique index emp_index on emp(emp_id);   
...
insert into employee values(200,'Tom','Cruise', 10, 3000),
(300,'Hugh','Laurie',20,7500),(400,'Tom','Hanks',30,750);      
insert into employee values(500,'Johnny','Depp', 20, 1300),(600,'Hugh','Grant',30,850),
(700,'Ben','Affleck',30,75),(800,'George','Clooney',10,10000);
...
select * from employee where deptno = 10 and salary > 3000;       # Question 1
...
(12,'Dyana',55.00),(13,'Jenny',66.00),(14,'Christene',88.00),
(15,'Meera',24.00),(16,'Priya',76.00),(17,'Priyanka',77.00),
(18,'Paige',74.00),(19,'Samantha',87.00),(21,'Julia',96.00),
(27,'Evil',79.00),(29,'Jane',64.00),(31,'Scarlet',80.00),
(32,'Kristeen',100.00),(34,'Fanny',75.00),(37,'Belvet',78.00),
(38,'Danny',75.00),(41,'Salma',81.00),(51,'Amanda',34.00),
(61,'Heraldo',94.00),(71,'Stuart',99.00),(76,'Amina',89.00),
(81,'Aamina',77.00),(91,'Vivek',84.00),(96,'Devil',76.00);

select * from students;

select *,                                          
case
when marks between 50 and 60 then "Secondclass"
when marks between 40 and 50 then "Thirdclass"
when marks between 60 and 80 then "Firstclass"
...
select count(*) from                                # Question 2(a)
(select *,
case
when marks between 50 and 60 then "Secondclass"
when marks between 40 and 50 then "Thirdclass"
...
from students) as firstclass_students where 
firstclass_students.grade = "Firstclass";


select count(*) from 
(select *,
case
when marks between 50 and 60 then "Secondclass"            # Question 2(b)
when marks between 40 and 50 then "Thirdclass"
when marks between 60 and 80 then "Firstclass"
when marks between 80 and 100 then "Distinctions"
else
...
from students) as firstclass_students where 
firstclass_students.grade = "Distinctions";
...
INSERT INTO `station` VALUES (794,'Kissee Mills','MO',139.65,73.42),
(824,'Loma Mar','CA',48.70,130.54),(603,'Sandy Hook','CT',72.34,148.24),
(478,'Tipton','IN',33.55,97.94),(619,'Arlington','CO',75.18,92.95),
(711,'Turner','AR',50.24,101.46),(839,'Slidell','LA',85.32,151.87),
(411,'Negreet','LA',98.97,105.34),(588,'Glencoe','KY',46.39,136.04),
(665,'Chelsea','IA',98.72,59.69),(342,'Chignik Lagoon','AK',103.20,153.01),
(733,'Pelahatchie','MS',38.58,28.12),(441,'Hanna City','IL',50.99,136.78),
(811,'Dorrance','KS',102.09,121.56),(698,'Albany','CA',49.75,80.21),
(325,'Monument','KS',70.52,141.77),(414,'Manchester','MD',73.52,37.15),
(113,'Prescott','IA',39.93,65.79),(971,'Graettinger','IA',94.66,150.38),
(266,'Cahone','CO',116.23,127.01),(617,'Sturgis','MS',36.46,126.17),
(495,'Upperco','MD',114.22,29.63),(473,'Highwood','IL',27.25,150.92),
(959,'Waipahu','HI',106.45,33.91),(438,'Bowdon','GA',88.98,78.49),
(571,'Tyler','MN',133.35,58.63),(92,'Watkins','CO',83.27,96.74),
(399,'Republic','MI',75.42,130.13),(426,'Millville','CA',32.56,145.74),
(844,'Aguanga','CA',79.89,65.94),(321,'Bowdon Junction','GA',85.93,33.60),
(606,'Morenci','AZ',104.90,110.20),(957,'South El Monte','CA',74.05,79.64),
(833,'Hoskinston','KY',65.75,65.68),(843,'Talbert','KY',39.86,58.85),
(166,'Mccomb','MS',74.04,42.63),(339,'Kirk','CO',141.10,136.33),
(909,'Carlock','IL',117.32,84.80),(829,'Seward','IL',72.42,90.21),
(766,'Gustine','CA',111.09,140.83),(392,'Delano','CA',126.35,91.50),
(555,'Westphalia','MI',32.77,143.81),(33,'Saint Elmo','AL',27.35,50.58),
(728,'Roy','MT',41.31,51.56),(656,'Pattonsburg','MO',138.10,32.11),
(394,'Centertown','MO',133.97,93.17),(366,'Norvell','MI',125.34,93.75),
(96,'Raymondville','MO',70.68,148.44),(867,'Beaver Island','MI',81.88,164.88),
(977,'Odin','IL',53.49,115.79),(741,'Jemison','AL',62.10,25.71),
(436,'West Hills','CA',68.43,73.10),(323,'Barrigada','GU',60.61,147.53),
(3,'Hesperia','CA',106.06,71.12),(814,'Wickliffe','KY',80.30,46.13),
(375,'Culdesac','ID',47.84,78.07),(467,'Roselawn','IN',87.71,51.75),
(604,'Forest Lakes','AZ',144.84,114.29),(551,'San Simeon','CA',37.53,28.34),
(706,'Little Rock','AR',122.24,121.15),(647,'Portland','AR',83.92,44.81),
(25,'New Century','KS',135.02,79.27),(250,'Hampden','MA',76.39,26.48),
(124,'Pine','MN',119.46,129.37),(547,'Sandborn','IN',55.95,93.85),
(701,'Seaton','IL',128.23,78.43),(197,'Milledgeville','IL',90.99,113.27),
(613,'East','MI',108.69,42.48),(630,'Prince','MD',104.83,57.72),(767,'Pomona','FL',100.52,163.35),
(679,'Gretna','LA',75.26,142.58),(896,'Yazoo','MS',95.01,85.22),
(403,'Zionsville','IN',57.79,36.49),(519,'Rio','CA',29.39,105.82),
(482,'Jolon','CA',66.65,52.96),(252,'Childs','MD',92.76,104.02),
(600,'Shreveport','LA',136.23,38.50),(14,'Forest','MS',120.28,50.23),
(260,'Sizerock','KY',116.02,112.75),(65,'Buffalo','CO',47.66,148.19),
(753,'Algonac','MI',118.74,80.15),(174,'Onaway','MI',108.61,55.76),
(263,'Irvington','IL',96.70,68.29),(253,'Winsted','MN',68.82,72.52),
(557,'Woodbury','GA',102.55,93.38),(897,'Samantha','AL',75.22,35.94),
(98,'Hackleburg','AL',119.56,120.62),(423,'Soldier','KS',77.30,152.60),
(361,'Arrowsmith','IL',28.00,109.34),(409,'Columbus','GA',67.34,46.62),
(312,'Bentonville','AR',36.95,78.07),(854,'Kirkland','AZ',86.41,58.00),
(160,'Grosse','MI',102.05,91.37),(735,'Wilton','ME',56.58,157.19),
(608,'Busby','MT',104.09,29.83),(122,'Robertsdale','AL',97.72,85.37),
(93,'Dale','IN',69.59,34.42),(67,'Reeds','MO',30.79,42.50),(906,'Hayfork','CA',35.30,116.67),
(34,'Mcbrides','MI',74.06,35.68),(921,'Lee Center','IL',95.79,77.13),
(401,'Tennessee','IL',55.50,155.65),(536,'Henderson','IA',77.92,77.91),
(953,'Udall','KS',112.68,59.96),(370,'Palm Desert','CA',106.81,145.76),
(614,'Benedict','KS',138.50,95.72),(998,'Oakfield','ME',47.66,132.21),
(805,'Tamms','IL',59.87,75.05),(235,'Haubstadt','IN',27.99,32.08),
...
select count(distinct(city)) as N1 from station;

select count(city) - count(distinct(city)) as "N-N1" from station;        

select distinct(city) from station where left(city,1)  LIKE 'a%' OR CITY LIKE 'e%' OR CITY LIKE 'i%' 
...
concat(emp.salary,"$") as Salary,
emp.hire_date,
timestampdiff(MONTH,"2023-08-12",emp.hire_date) as difference_in_months         
from emp 
where salary > 2000 
having difference_in_months < 36
order by salary desc;
...
INSERT INTO `city` VALUES (6,'Rotterdam','NLD','Zuid-Holland',593321),(3878,'Scottsdale','USA','Arizona',202705),
(3965,'Corona','USA','California',124966),(3973,'Concord','USA','California',121780),(3977,'Cedar Rapids','USA','Iowa',120758),
(3982,'Coral Springs','USA','Florida',117549),(4054,'Fairfield','USA','California',92256),(4058,'Boulder','USA','Colorado',91238),
(4061,'Fall River','USA','Massachusetts',90555),(1613,'Neyagawa','JPN','Osaka',257315),(1630,'Ageo','JPN','Saitama',209442),
(1661,'Sayama','JPN','Saitama',162472),(1681,'Omuta','JPN','Fukuoka',142889),(1739,'Tokuyama','JPN','Yamaguchi',107078);

select * from city;

select name as city_name,population from city where population > 100000;          # Question 8

select sum(population) as total_population_california from city where district = "California"; # Question 9

select district as District,AVG(population) as Average_population from city group by District;  # Question 10
...
(10113,'2003-03-26','2003-04-02','2003-03-27','Shipped',NULL,124),(10114,'2003-04-01','2003-04-07','2003-04-02','Shipped',NULL,172),
(10115,'2003-04-04','2003-04-12','2003-04-07','Shipped',NULL,424),(10116,'2003-04-11','2003-04-19','2003-04-13','Shipped',NULL,381),
(10117,'2003-04-16','2003-04-24','2003-04-17','Shipped',NULL,148),(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',216),
...
(10125,'2003-05-21','2003-05-27','2003-05-24','Shipped',NULL,114),(10126,'2003-05-28','2003-06-07','2003-06-02','Shipped',NULL,458),
...
(10128,'2003-06-06','2003-06-12','2003-06-11','Shipped',NULL,141),(10129,'2003-06-12','2003-06-18','2003-06-14','Shipped',NULL,324),
(10130,'2003-06-16','2003-06-24','2003-06-21','Shipped',NULL,198),(10131,'2003-06-16','2003-06-25','2003-06-21','Shipped',NULL,447),
(10132,'2003-06-25','2003-07-01','2003-06-28','Shipped',NULL,323),(10133,'2003-06-27','2003-07-04','2003-07-03','Shipped',NULL,141),
(10134,'2003-07-01','2003-07-10','2003-07-05','Shipped',NULL,250),(10135,'2003-07-02','2003-07-12','2003-07-03','Shipped',NULL,124),
(10136,'2003-07-04','2003-07-14','2003-07-06','Shipped','Customer is interested in buying more Ferrari models',242),
(10137,'2003-07-10','2003-07-20','2003-07-14','Shipped',NULL,353),(10138,'2003-07-07','2003-07-16','2003-07-13','Shipped',NULL,496),
(10139,'2003-07-16','2003-07-23','2003-07-21','Shipped',NULL,282),(10140,'2003-07-24','2003-08-02','2003-07-30','Shipped',NULL,161),
(10141,'2003-08-01','2003-08-09','2003-08-04','Shipped',NULL,334),(10142,'2003-08-08','2003-08-16','2003-08-13','Shipped',NULL,124),
(10143,'2003-08-10','2003-08-18','2003-08-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',320),
(10144,'2003-08-13','2003-08-21','2003-08-14','Shipped',NULL,381),(10145,'2003-08-25','2003-09-02','2003-08-31','Shipped',NULL,205),
(10146,'2003-09-03','2003-09-13','2003-09-06','Shipped',NULL,447),(10147,'2003-09-05','2003-09-12','2003-09-09','Shipped',NULL,379),
(10148,'2003-09-11','2003-09-21','2003-09-15','Shipped','They want to reevaluate their terms agreement with Finance.',276),
(10149,'2003-09-12','2003-09-18','2003-09-17','Shipped',NULL,487),(10150,'2003-09-19','2003-09-27','2003-09-21','Shipped','They want to reevaluate their terms agreement with Finance.',148),
(10151,'2003-09-21','2003-09-30','2003-09-24','Shipped',NULL,311),(10152,'2003-09-25','2003-10-03','2003-10-01','Shipped',NULL,333),
(10153,'2003-09-28','2003-10-05','2003-10-03','Shipped',NULL,141),(10154,'2003-10-02','2003-10-12','2003-10-08','Shipped',NULL,219),
(10155,'2003-10-06','2003-10-13','2003-10-07','Shipped',NULL,186),(10156,'2003-10-08','2003-10-17','2003-10-11','Shipped',NULL,141),
(10157,'2003-10-09','2003-10-15','2003-10-14','Shipped',NULL,473),(10158,'2003-10-10','2003-10-18','2003-10-15','Shipped',NULL,121),
(10159,'2003-10-10','2003-10-19','2003-10-16','Shipped',NULL,321),(10160,'2003-10-11','2003-10-17','2003-10-17','Shipped',NULL,347),
(10161,'2003-10-17','2003-10-25','2003-10-20','Shipped',NULL,227),(10162,'2003-10-18','2003-10-26','2003-10-19','Shipped',NULL,321),
(10163,'2003-10-20','2003-10-27','2003-10-24','Shipped',NULL,424),(10164,'2003-10-21','2003-10-30','2003-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesn\'t like the colors and precision of the models.',452),
...
(10168,'2003-10-28','2003-11-03','2003-11-01','Shipped',NULL,161),(10169,'2003-11-04','2003-11-14','2003-11-09','Shipped',NULL,276),
(10170,'2003-11-04','2003-11-12','2003-11-07','Shipped',NULL,452),(10171,'2003-11-05','2003-11-13','2003-11-07','Shipped',NULL,233),
...
(10174,'2003-11-06','2003-11-15','2003-11-10','Shipped',NULL,333),(10175,'2003-11-06','2003-11-14','2003-11-09','Shipped',NULL,324),
(10176,'2003-11-06','2003-11-15','2003-11-12','Shipped',NULL,386),(10177,'2003-11-07','2003-11-17','2003-11-12','Shipped',NULL,344),
...
(10180,'2003-11-11','2003-11-19','2003-11-14','Shipped',NULL,171),(10181,'2003-11-12','2003-11-19','2003-11-15','Shipped',NULL,167),
...
(10187,'2003-11-15','2003-11-24','2003-11-16','Shipped',NULL,211),(10188,'2003-11-18','2003-11-26','2003-11-24','Shipped',NULL,167),
(10189,'2003-11-18','2003-11-25','2003-11-24','Shipped','They want to reevaluate their terms agreement with Finance.',205),
(10190,'2003-11-19','2003-11-29','2003-11-20','Shipped',NULL,141),(10191,'2003-11-20','2003-11-30','2003-11-24','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',259),
(10192,'2003-11-20','2003-11-29','2003-11-25','Shipped',NULL,363),(10193,'2003-11-21','2003-11-28','2003-11-27','Shipped',NULL,471),
(10194,'2003-11-25','2003-12-02','2003-11-26','Shipped',NULL,146),(10195,'2003-11-25','2003-12-01','2003-11-28','Shipped',NULL,319),
...
(10206,'2003-12-05','2003-12-13','2003-12-08','Shipped','Can we renegotiate this one?',202),(10207,'2003-12-09','2003-12-17','2003-12-11','Shipped','Check on availability.',495),
(10208,'2004-01-02','2004-01-11','2004-01-04','Shipped',NULL,146),(10209,'2004-01-09','2004-01-15','2004-01-12','Shipped',NULL,347),
(10210,'2004-01-12','2004-01-22','2004-01-20','Shipped',NULL,177),(10211,'2004-01-15','2004-01-25','2004-01-18','Shipped',NULL,406),
...
(10216,'2004-02-02','2004-02-10','2004-02-04','Shipped',NULL,256),(10217,'2004-02-04','2004-02-14','2004-02-06','Shipped',NULL,166),
...
(10219,'2004-02-10','2004-02-17','2004-02-12','Shipped',NULL,487),(10220,'2004-02-12','2004-02-19','2004-02-16','Shipped',NULL,189),
(10221,'2004-02-18','2004-02-26','2004-02-19','Shipped',NULL,314),(10222,'2004-02-19','2004-02-27','2004-02-20','Shipped',NULL,239),
(10223,'2004-02-20','2004-02-29','2004-02-24','Shipped',NULL,114),(10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',171),
(10225,'2004-02-22','2004-03-01','2004-02-24','Shipped',NULL,298),(10226,'2004-02-26','2004-03-06','2004-03-02','Shipped',NULL,239),
(10227,'2004-03-02','2004-03-12','2004-03-08','Shipped',NULL,146),(10228,'2004-03-10','2004-03-18','2004-03-13','Shipped',NULL,173),
...
(10231,'2004-03-19','2004-03-26','2004-03-25','Shipped',NULL,344),(10232,'2004-03-20','2004-03-30','2004-03-25','Shipped',NULL,240),
...
(10243,'2004-04-26','2004-05-03','2004-04-28','Shipped',NULL,495),(10244,'2004-04-29','2004-05-09','2004-05-04','Shipped',NULL,141),
(10245,'2004-05-04','2004-05-12','2004-05-09','Shipped',NULL,455),(10246,'2004-05-05','2004-05-13','2004-05-06','Shipped',NULL,141),
...
DELIMITER //
create procedure order_status (IN year_p int,IN month_p int)             
BEGIN
select orderNumber,
       orderDate,
       status 
from orders 
where year(orderDate) = year_p 
AND 
month(orderDate) = month_p;
END //
DELIMITER ;
...
o.status 
from
customers c left join orders o using (customerNumber);
...
set movieid = NULL
where movieid not in (select distinct id from movies);
Delete from rentals where  movieid = NULL;
end //
DELIMITER ;

DELIMITER //
create trigger delete_cascade2
After delete on movies
for each row
Begin
Delete from rentals
...
update movies set id = 16 where id = 10;

select * from rentals;

delete from rentals where movieid IS NULL;
...
select *,
dense_rank() over(order by salary desc) as emp_rank  from employee;   
